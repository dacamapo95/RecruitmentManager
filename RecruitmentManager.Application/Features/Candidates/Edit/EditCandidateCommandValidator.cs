...
public sealed class EditCandidateCommandValidator : AbstractValidator<EditCandidateCommand>
{
    public EditCandidateCommandValidator()
    {
        RuleFor(x => x.Id)
        ...
        RuleFor(x => x.FirstName)
            ...
            .MaximumLength(50).WithMessage("First name cannot exceed 100 characters");

        RuleFor(x => x.SurName)
            .NotEmpty().WithMessage("Last name is required")
            .MaximumLength(150).WithMessage("Last name cannot exceed 100 characters");
